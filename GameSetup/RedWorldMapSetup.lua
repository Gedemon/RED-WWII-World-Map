...
ScenarioCivilizations = {
	...
	[1] = "CIVILIZATION_ENGLAND",
	[2] = "CIVILIZATION_FRANCE",
	[3] = "CIVILIZATION_GERMANY",
	[4] = "CIVILIZATION_ROME",
	[5] = "CIVILIZATION_RUSSIA",
	[6] = "CIVILIZATION_CHINA",
...
myModId = "c3465219-8fbe-464c-94a0-6a46e2efd3d5";
myModVersion = Modding.GetActivatedModVersion(myModId);
scenarioMap = Modding.GetEvaluatedFilePath(myModId, myModVersion, "RedWorldMap.Civ5Map");
